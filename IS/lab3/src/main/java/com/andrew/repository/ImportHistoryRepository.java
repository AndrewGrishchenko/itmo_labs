...
public class ImportHistoryRepository {
    ...
    public void update(ImportHistory importHistory) {
        sessionFactory.getCurrentSession().merge(importHistory);
    }

    public void markError(ImportHistory importHistory) {
        importHistory.setOperationStatus(OperationStatus.ERROR);
        sessionFactory.getCurrentSession().merge(importHistory);
        sessionFactory.getCurrentSession().flush();
    }

    public void markOk(ImportHistory importHistory) {
        importHistory.setOperationStatus(OperationStatus.OK);
        sessionFactory.getCurrentSession().merge(importHistory);
        sessionFactory.getCurrentSession().flush();
    }
